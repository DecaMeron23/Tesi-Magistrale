...
#define LED_NUCLEO_Pin GPIO_PIN_2
...
#define RBG_LED_PWM_Pin GPIO_PIN_7
#define RBG_LED_PWM_GPIO_Port GPIOA
...
#define RBG_LED_SELECT_Pin GPIO_PIN_1
#define RBG_LED_SELECT_GPIO_Port GPIOH
