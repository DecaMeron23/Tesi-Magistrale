...
{
  /* P2P_SERVICE */
  CUSTOM_STM_LED_CTRL_CHAR,
  CUSTOM_STM_NOTIFY_PUSH_BTN_C,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* LED_CONTROL_CHAR */
  CUSTOM_STM_LED_CTRL_CHAR_READ_EVT,
  CUSTOM_STM_LED_CTRL_CHAR_WRITE_NO_RESP_EVT,
  /* NOTIFY_PUSH_BTN_CHAR */
  CUSTOM_STM_NOTIFY_PUSH_BTN_C_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_NOTIFY_PUSH_BTN_C_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeLed_Ctrl_Char;
extern uint16_t SizeNotify_Push_Btn_C;
