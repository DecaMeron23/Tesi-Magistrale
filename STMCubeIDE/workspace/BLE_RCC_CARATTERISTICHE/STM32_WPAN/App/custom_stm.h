...
typedef enum
{
  ...
  CUSTOM_STM_TIME,
  /* PWM */
  CUSTOM_STM_FREQUENCY,
  CUSTOM_STM_DUTY_CYCLE,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeTime;
extern uint16_t SizeFrequency;
extern uint16_t SizeDuty_Cycle;
